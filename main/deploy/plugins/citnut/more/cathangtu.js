...
module.exports = {
	...
	name: 'đếm ngược đến ngày 01 tháng 04',
	...
	async onCall(message, reply) {
		...
		if (setting.run.cathangtu != true) {
			return reply("plugin này đã bị tắt")
		}else {
			const data = await festival("ca");
